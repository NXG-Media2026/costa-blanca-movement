---
title: "Sciatica vs Herniated Disc: Understanding the Difference"
pageSlug: "sciatica-vs-herniated-disc"
lang: "en"
date: "2026-02-15"
...
1. **Medical history** — when symptoms started, what makes them better or worse, any previous injuries
2. **Physical examination** — specific tests for nerve compression, range of motion, muscle strength, and reflexes
3. **Movement assessment** — how you move, stand, and sit can reveal a lot about the underlying cause
4. **Imaging referral** — if needed, we can refer you for MRI or X-ray to confirm the diagnosis
